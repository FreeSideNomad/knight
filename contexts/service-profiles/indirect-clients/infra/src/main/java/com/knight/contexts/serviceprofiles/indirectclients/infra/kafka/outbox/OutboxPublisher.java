package com.knight.contexts.serviceprofiles.indirectclients.infra.kafka.outbox;

import com.knight.contexts.serviceprofiles.indirectclients.infra.kafka.config.KafkaProducerConfig;
...
public class OutboxPublisher {
    ...
    public OutboxPublisher(
        ...
        this.topicPrefix = "indirect-clients";
    ...
    private void publishEvent(OutboxEventEntity event) {
        try {
            // Build topic name: indirect-clients.indirect-client-onboarded
    ...
    private String toKebabCase(String eventType) {
        // Convert "IndirectClientOnboarded" to "indirect-client-onboarded"
        return eventType

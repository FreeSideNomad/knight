package com.knight.contexts.approvalworkflows.engine.infra.kafka.outbox;

import com.knight.contexts.approvalworkflows.engine.infra.kafka.config.KafkaProducerConfig;
...
public class OutboxPublisher {
    ...
    private void publishEvent(OutboxEventEntity event) {
        try {
            // Build topic name: approvals.workflow-initiated
    ...
    private String toKebabCase(String eventType) {
        // Convert "WorkflowInitiated" to "workflow-initiated"
        return eventType

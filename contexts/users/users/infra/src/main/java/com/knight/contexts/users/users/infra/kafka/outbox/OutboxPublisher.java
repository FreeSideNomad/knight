package com.knight.contexts.users.users.infra.kafka.outbox;

import com.knight.contexts.users.users.infra.kafka.config.KafkaProducerConfig;
...
public class OutboxPublisher {
    ...
    private void publishEvent(OutboxEventEntity event) {
        try {
            // Build topic name: users.user-created
    ...
    private String toKebabCase(String eventType) {
        // Convert "UserCreated" to "user-created"
        return eventType
